...
class Futbolista:
    def __init__(self, nombre, posicion, precio):
        ...
        self.año_retiro = set()  # Set para el año de retiro
    ...
    def fichas(self):
        ...
        if self.año_retiro:
            print(f" - Año de retiro:\t{', '.join(map(str, self.año_retiro))}")
    ...
    def futbolista_retirado(self):
        # Añade un año aleatorio de retiro entre 2019 y 2024 al conjunto año_retiro
...
class EquipoFutbol:
    ...
    def comprar_jugadores(self, jugador):
        ...
        elif self.inversion < jugador._Futbolista__precio:
            print(f"{self.nombre} no tiene suficiente dinero para comprar a {jugador._Futbolista__nombre}")
        else:
            self.jugadores.append(jugador)  
            self.inversion -= jugador._Futbolista__precio  
            print(f"{self.nombre} ha comprado a {jugador._Futbolista__nombre} por ${jugador._Futbolista__precio}. Inversión restante:${self.inversion}")
    ...
    def vender_jugadores(self, jugador):
        if jugador in self.jugadores:
            ...
            self.inversion += jugador._Futbolista__precio
            print(f"{jugador._Futbolista__nombre} ha sido vendido por {self.nombre}")
        else:
            print(f"{jugador._Futbolista__nombre} no está en el equipo {self.nombre}")
...
for equipo in equipos:
    ...
    for jugador in equipo.jugadores:
        jugador.futbolista_retirado()  # Llama a la función para establecer el año de retiro
        jugador.fichas()
